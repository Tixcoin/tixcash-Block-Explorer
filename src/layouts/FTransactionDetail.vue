            ...
            <template v-if="!dTransactionByHashError">
                ...
                <template v-else>
                    ...
                    <div class="row no-collapse">
                        ...
                        <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToTXH(cTransaction.value) }} TXH</div></div>
                    </div>
                    <!--
                                <div class="row no-collapse">
                                    <div class="col-4 f-row-label">{{ $t('view_transaction_detail.fee') }}</div>
                                    <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToTXH(cTransaction.fee) }} TXH</div></div>
                                </div>
                    -->
                    <div class="row no-collapse">
                    ...
                    <div class="row no-collapse">
                        ...
                        <div class="col"><div class="break-word" v-show="cTransaction">{{  cTransactionFee }} TXH</div></div>
                    </div>
                    <div class="row no-collapse">
    ...
    export default {
        ...
        computed: {
            ...
            cTransactionFee() {
                ...
                if (transaction) {
                    return WEIToTXH(this.formatHexToInt(transaction.gasPrice) * this.formatHexToInt(transaction.gasUsed));
                }
