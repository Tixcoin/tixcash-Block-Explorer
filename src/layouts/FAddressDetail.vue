                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="cAccount">
                                <f-t-m-token-value :value="cAccount ? cAccount.totalValue : 1" convert no-currency /> <span class="TXH">TXH</span>
                            </span>
                        </h3>
                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="'available' in cAssets">
                                <f-t-m-token-value :value="cAssets.available" convert no-currency /> <span class="TXH">TXH</span>
                            </span>
                        </h3>
                ...
                <f-card>
                    ...
                    <!--
                                            <div class="row no-collapse">
                                                ...
                                                <div class="col">
                                                    <div v-show="'available' in cAssets">{{ toTXH(cAssets.available) }} TXH</div>
                                                </div>
                                            </div>
                    -->
                    <div class="row no-collapse">
                    ...
                    <div class="row no-collapse">
                        ...
                        <div class="col">
                            <div v-show="'claimed_rewards' in cAssets">
                                -
                                <!--{{ toTXH(cAssets.claimed_rewards, true) }} TXH-->
                            </div>
                        </div>
                    </div>
                    <div class="row no-collapse">
        ...
        <!--
                    ...
                    <f-card>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="num-block">
                                    <h2 class="h3">{{ $t('view_address_detail.value_in_TXH') }}</h2>
                                    <div class="num"><span v-show="cAccount">{{ toTXH(cAccount ? cAccount.totalValue : 1) }}</span></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="num-block">
...
<script>
    ...
    import { WEIToTXH, TXHToUSD } from "../utils/transactions.js";
    ...
    import TXHTokenValue from "@/components/core/TXHTokenValue/TXHTokenValue.vue";
...
/*
                dAssetColumns: [
                    ...
                    {
                        name: 'valueInTXH',
                        label: this.$t('view_address_detail.value_in_TXH'),
                        cssClass: 'align-end',
                    },
                    {
                        name: 'valueInUSD',
                ...
                if (cAccount) {
                    ...
                    if (delegations && delegations.edges) {
                        delegations.edges.forEach((_edge) => {
                            ...
                            assets.delegated += (delegation ? WEIToTXH(delegation.amount) : 0);
                            assets.pending_rewards += (delegation && delegation.pendingRewards ? WEIToTXH(delegation.pendingRewards.amount) : 0);
                            assets.claimed_rewards += (delegation ? WEIToTXH(delegation.claimedReward) : 0);
                        });
...
/*
            getAssetItem(_assetName, _value) {
                return {
                    asset: _assetName,
                    balance: this.toTXH(_value),
                    valueInTXH: this.toTXH(_value),
...
*/
             ...
             * @return {string}
             */
            toTXH(_value, _isNumber) {
                return _isNumber ? _value : WEIToTXH(_value);
            },
             ...
             */
            toUSD(_value) {
                return TXHToUSD(WEIToTXH(_value), this.$store.state.tokenPrice);
            },
