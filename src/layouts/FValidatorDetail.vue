                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'stake' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToTXH(cStaker.stake), 0)) }} TXH
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'delegatedMe' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToTXH(cStaker.delegatedMe), 0)) }} TXH
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'totalStake' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToTXH(cStaker.totalStake), 0)) }} TXH
                        </div>
                    </div>
                </div>
