                ...
                <div class="col margin-bottom-menu">
                    <f-card>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fSelfStaked' in dTotals">{{ dTotals.fSelfStaked }} TXH <span v-if="cSelfStaked">({{ cSelfStaked }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fTotalDelegated' in dTotals">{{ dTotals.fTotalDelegated }} TXH <span v-if="cDelegated">({{ cDelegated }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fTotalStaked' in dTotals">{{ dTotals.fTotalStaked }} TXH <span v-if="cStaked">({{ cStaked }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="cDailyRewards">{{ formatNumberByLocale(numToFixed(cDailyRewards, 0)) }} TXH</div>
                            </div>
                        </div>
                ...
                <div class="col">
                    <f-card>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'epochFee' in cEpoch">{{  WEIToTXH(cEpoch.epochFee) }} TXH</div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="dTotalSupply">{{ formatNumberByLocale(numToFixed(dTotalSupply, 0)) }} TXH</div>
                            </div>
                        </div>
                    </f-card>
                </div>
    ...
    export default {
        ...
        apollo: {
            ...
            epoch: {
                ...
                result(_data) {
                    this.dTotalSupply = WEIToTXH(_data.data.epoch.totalSupply);
                },
                error(_error) {
                    this.dValidatorsInfoError = _error.message;
                }
        ...
        computed: {
            ...
            cDailyRewards() {
                ...
                if (epoch && epoch.baseRewardPerSecond) {
                    return WEIToTXH(epoch.baseRewardPerSecond) * 86400;
                }
