<template>
    <div class="view-home narrow-container">
        ...
        <div v-if="showNetworkNodesMap" class="row mat-5">
            <div class="col">
                <f-card class="half-padding">
                    <h2 class="h3">
                        Tixcash Mainnet Nodes
                        <f-info show-on-hover button-tooltip="" window-class="light" window-style="max-width: 350px;">
                            All RPC, read-only and validator nodes synced to Tixchash Mainnet.
                        </f-info>
                    </h2>
                    <network-nodes-map />
                </f-card>
        ...
        <div class="row mat-5">
            <div class="col">
                <f-card class="half-padding">
                    <h2 class="h3">Total TXH Burned</h2>
                    <BurnedTXH />
                </f-card>
            </div>
        </div>
...
<script>
    ...
    import BurnedTXH from "@/components/BurnedTXH.vue";
