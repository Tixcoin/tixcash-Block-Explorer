    ...
    data() {
        return {
            ...
            dColumns: [
                ...
                /*{
                    name: 'baseReward',
                    label: this.$t('epoch.total_base_reward') + ' (TXH)',
                    itemProp: 'epoch.totalBaseRewardWeight',
                    formatter: (_value) => formatNumberByLocale(WEIToTXH(_value), 1, 2),
                    cssClass: 'align-end',
                },*/
                {
                    name: 'fee',
                    label: this.$t('epoch.total_fee') + ' (TXH)',
                    itemProp: 'epoch.epochFee',
                    formatter: (_value) => WEIToTXH(_value),
                    cssClass: 'align-end',
                },
                /*{
                    name: 'txReward',
                    label: this.$t('epoch.total_tx_reward') + ' (TXH)',
