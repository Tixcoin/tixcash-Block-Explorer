                    ...
                    <div v-if="column" class="row no-collapse no-vert-col-padding">
                        ...
                        <div class="col break-word">
                            <div class="validator-img">
                                ...
                                <img v-else src="/img/tixcash-logo.png" alt="tixcash logo" class="not-fluid">
                            </div>
                        </div>
                    </div>
                    <template v-else>
                ...
                result(_data, _key) {
                    ...
                    if (_key === 'stakers') {
                        ...
                        data.forEach((_item, _idx) => {
                            // _item.total_staked = WEIToTXH(_item.stake) + WEIToTXH(_item.delegatedMe);
                            totals.selfStaked += parseFloat(numToFixed(WEIToTXH(_item.stake), 0));
                            totals.totalDelegated += parseFloat(numToFixed(WEIToTXH(_item.delegatedMe), 0));
                            totals.totalStaked += parseFloat(numToFixed(WEIToTXH(_item.totalStake), 0));
            ...
            return {
                ...
                dColumns: [
                    ...
                    },
                    {
                        ...
                        formatter: _value => formatNumberByLocale(numToFixed(WEIToTXH(_value), 0), 0),
                        sortFunc: sortByHex,
                        cssClass: 'align-end',
                    },
                    {
